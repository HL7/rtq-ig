Alias: $ctd-section = http://hl7.org/fhir/uv/apix/CodeSystem/ctd-section
Alias: $rtq-identifier-type = http://hl7.org/fhir/uv/rtq/CodeSystem/rtq-identifier-type
Alias: $ctd-categories-full = http://hl7.org/fhir/uv/rtq/CodeSystem/ctd-categories-full
