...
<p style="padding: 1rem; background-color: #f8fafc; border-left: 4px solid #3b82f6; border-radius: 4px;">    <strong>💡 See it in action:</strong> <a href="theme-modern-saas.html" target="_blank">View the interactive Modern SaaS Dashboard Example</a></p>
